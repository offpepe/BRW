...
namespace BRW.API.Migrations
{
    ...
    [Migration("20220119043154_UpdateUserBindNeverId")]
    partial class UpdateUserBindNeverId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BRW.API.Entities.Championship", b =>
                {
                    ...
                    b.HasIndex("GameId")
                        .HasDatabaseName("ix_championship_game_id");
            ...
            modelBuilder.Entity("BRW.API.Entities.Championship", b =>
                {
                    b.HasOne("BRW.API.Entities.Game", null)
                        .WithMany("Championships")
                        .HasForeignKey("GameId")
                        .HasConstraintName("fk_championship_games_game_id");
